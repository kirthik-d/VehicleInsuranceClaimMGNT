...
namespace VehicleInsuranceClaimMSAPIConnect.Migrations
{
    ...
    [Migration("20230405101555_FirstMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.Claims", b =>
                {
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.InsuranceCompanies", b =>
                {
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.Login", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.Policy", b =>
                {
                    b.Property<int>("PolicyId")
                        .HasColumnName("Policy_Id");
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.Users", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnName("User_ID");
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.Vehicles", b =>
                {
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.Claims", b =>
                {
                    b.HasOne("VehicleInsuranceClaimMSAPIConnect.Service.Policy", "Policy")
                        .WithMany("Claims")
                        .HasForeignKey("PolicyId")
                        .HasConstraintName("Fk_policyid")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("VehicleInsuranceClaimMSAPIConnect.Service.Users", "User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.Policy", b =>
                {
                    b.HasOne("VehicleInsuranceClaimMSAPIConnect.Service.Vehicles", "Vehicle")
                        .WithMany("Policy")
            ...
            modelBuilder.Entity("VehicleInsuranceClaimMSAPIConnect.Service.Vehicles", b =>
                {
                    b.HasOne("VehicleInsuranceClaimMSAPIConnect.Service.Users", "Owner")
                        .WithMany("Vehicles")
